...
import models.{UserServiceImpl, UserService, User}
import persistence.UsersPersistence
import persistence.slick.silhouette._
...
class SilhouetteModule extends AbstractModule /* with ScalaModule */ {
  ...
  def configure() {
    ...
    bind(classOf[UsersPersistence]).to(classOf[UsersPersistenceImpl])
    bind(classOf[DelegableAuthInfoDAO[PasswordInfo]]).to(classOf[PasswordInfoDAO])
    bind(classOf[DelegableAuthInfoDAO[OAuth1Info]]).to(classOf[OAuth1InfoDAO])
    bind(classOf[DelegableAuthInfoDAO[OAuth2Info]]).to(classOf[OAuth2InfoDAO])
    bind(classOf[DelegableAuthInfoDAO[OpenIDInfo]]).to(classOf[OpenIDInfoDAO])
