package persistence.slick.silhouette
...
/**
  ...
  */
class UsersPersistenceImpl @Inject()(protected val dbConfigProvider: DatabaseConfigProvider) extends UsersPersistence with DAOSlick {
