...
import models.{ItemException, Bidder, Item, Bid$}
...
object ItemsPersistenceAnorm extends AnormPersistence with ItemsPersistence {
  ...
  override def load(itemsActor: ActorRef): Try[Boolean] = withDBConnection {
    implicit c =>
  ...
  override def itemById(id: Long): Try[Option[Item]] = withDBConnection {
    implicit c =>
  ...
  override def winningBidById(id: Long): Try[Option[Bid]] = withDBConnection {
    implicit c =>
  ...
  override def winningBidsByBidder(bidder: Bidder): Try[List[Bid]] = withDBConnection {
    implicit c =>
  ...
  override def editWinningBid(winningBidId: Long, bidder: Bidder, item: Item, amount: BigDecimal): Try[Bid] = withDBConnection {
    implicit c =>
  ...
  override def edit(item: Item): Try[Item] = withDBConnection {
    implicit c =>
      itemEditSQL.on(
        'id -> item.id.get,
  ...
  override def delete(item: Item): Try[Item] = withDBConnection {
    implicit c =>
  ...
  override def delete(winningBid: Bid): Try[Bid] = withDBConnection {
    implicit c =>
  ...
  override def itemByItemNumber(itemNumber: String): Try[Option[Item]] = withDBConnection {
    implicit c =>
  ...
  override def winningBidsByItem(item: Item): Try[List[Bid]] = withDBConnection {
    implicit c =>
  ...
  override def sortedItems: Try[List[Item]] = withDBConnection {
    implicit c =>
  ...
  override def create(item: Item): Try[Item] = withDBConnection {
    implicit c =>
      createItemSQL.on(
        'item_number -> item.itemNumber,
        'category -> item.category,
  ...
  override def create(winningBid: Bid): Try[Bid] = withDBConnection {
    implicit c =>
